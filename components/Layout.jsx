...
import { BlobShape, BlobProvider, BlobScene, BlobCircle } from "./Blobs";
    ...
    return (
        ...
        >
            <div>
                <Link href="/">
                    <a>
                        <svg viewBox="0 0 1024 1024" height="78" width="78">
                            <path
                                fill="currentColor"
...
export const Layout = ({ children }) => {
    return (
        ...
        >
            <BlobScene position={["100%", 0]}>
                <BlobShape
                    scale={2.6}
                    shape="M0 324C-21.3 310 -42.6 296.1 -66.8 292.5C-90.9 288.9 -118 295.7 -139.3 289.2C-160.6 282.8 -176.2 263.1 -198.3 248.6C-220.4 234.2 -248.9 224.9 -252.5 201.4C-256.1 177.9 -234.7 140.2 -245.1 118C-255.4 95.8 -297.4 89.2 -315.9 72.1C-334.3 55 -329.2 27.5 -324 0L0 0Z"
                />
                <BlobCircle translate={[-370, 170]} radius={20} />
                <BlobCircle translate={[-100, 450]} radius={40} />
            </BlobScene>
            <BlobScene position={[0, "100%"]}>
                <BlobShape
                    scale={2.4}
                    shape="M0 -324C21.1 -299.6 42.2 -275.2 59 -258.4C75.7 -241.5 88 -232.1 114.1 -237C140.2 -241.9 180 -261 202 -253.3C224.1 -245.6 228.4 -210.9 229.1 -182.7C229.8 -154.5 226.9 -132.7 240.6 -115.8C254.3 -99 284.6 -87.2 301.3 -68.8C317.9 -50.3 321 -25.1 324 0L0 0Z"
                />
            </BlobScene>
